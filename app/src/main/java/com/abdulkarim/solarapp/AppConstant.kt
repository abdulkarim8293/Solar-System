...
class AppConstant {
    ...
    companion object {
        ...
        const val IMAGE_URL_OF_MERCURY = "https://scx2.b-cdn.net/gfx/news/hires/2015/whatsimporta.jpg"
        const val IMAGE_URL_OF_VENUS = "https://scitechdaily.com/images/Venus-Planet.jpg"
        const val IMAGE_URL_OF_EARTH = "https://cdn.mos.cms.futurecdn.net/YLMh9EJRPhmht9GWNhiN7G-1200-80.jpg"
        const val IMAGE_URL_OF_MARS = "https://thumbs.dreamstime.com/b/mars-red-planet-solar-system-space-high-resolution-art-presents-isolated-white-giant-hi-d-rendered-background-182417516.jpg"
        const val IMAGE_URL_OF_JUPITER = "https://cdn.mos.cms.futurecdn.net/iEv6pmS4gfbefs5JbwHWiJ.png"
        const val IMAGE_URL_OF_SATURN = "https://www.worldatlas.com/r/w1200/upload/fb/fb/a7/shutterstock-517659922.jpg"
        const val IMAGE_URL_OF_URANUS = "https://mediaproxy.salon.com/width/1200/https://media.salon.com/2021/05/planet-uranus-0519211.jpg"
        const val IMAGE_URL_OF_NEPTUNE = "https://cdn.cdnparenting.com/articles/2019/03/30155119/523870474-H.jpg"
